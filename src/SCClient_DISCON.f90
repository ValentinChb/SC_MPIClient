...
subroutine SCClient_DISCON (avrSWAP, aviFAIL, avcINFILE, avcOUTNAME, avcMSG) bind(c,name='SCClient_DISCON')
    ...
    write(fidout,'(*(e13.5))') avrSWAP(2), avrSWAP(21), avrSWAP(45)*180.0/pi, avrSWAP(4)*180.0/pi, avrSWAP(47), avrSWAP(13), avrSWAP(15), avrSWAP(27), avrSWAP(87), avrSWAP(48), yawangle_cmd, yawangle_meas, yawangle_cmd_sat, yawrate, yawrate_sat
